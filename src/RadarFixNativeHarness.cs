...
internal static class RadarFixNativeHarness {
 ...
 static void ValidateLog(string file,string language,Action<string,bool,object?,string> check){
  ...
  bool valid=PublicReportTests.HasExpectedSectionContract(file);
  ...
  check("I all Gold report section counts and hashes "+language,valid,null,"SYNTHETIC_FORMAL_EXPORT");
