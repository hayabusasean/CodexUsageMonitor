...
Published v0.4.0 uses informational version `0.4.0+gold`. The release assets contain the authoritative executable and ZIP checksums. Independent builds can differ in bytes; do not infer byte identity from a version string alone.
